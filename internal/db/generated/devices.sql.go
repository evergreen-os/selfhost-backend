...
func (q *Queries) GetDeviceBySerialNumber(ctx context.Context, hardwareSerialNumber *string) (Device, error) {
	row := q.db.QueryRow(ctx, getDeviceBySerialNumber, hardwareSerialNumber)
	var i Device
	err := row.Scan(
		&i.ID,
		&i.DeviceID,
